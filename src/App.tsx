...
const ReportAgingByClient = lazy(() => import("./pages/ReportAgingByClient"));
        ...
        <AuthProvider>
          <TenantProvider>
            ...
            <Route path="/admin" element={<AdminAuthGate />}>
              ...
              <Route path="security" element={<ProtectedRoute requiredRole={['admin']}><ModernAppLayout><SecurityConsole /></ModernAppLayout></ProtectedRoute>} />
              <Route path="support-tickets" element={<ProtectedRoute requiredRole={['admin']}><ModernAppLayout><SupportTicketsConsole /></ModernAppLayout></ProtectedRoute>} />
              <Route path="social-links" element={<ProtectedRoute requiredRole={['admin']}><ModernAppLayout><SocialLinksSettings /></ModernAppLayout></ProtectedRoute>} />
              ...
              <Route path="reports/aging-by-client" element={<ProtectedRoute requireAuth><ModernAppLayout><ReportAgingByClient /></ModernAppLayout></ProtectedRoute>} />
              <Route path="reports/ops-payables" element={<ProtectedRoute requireAuth><ModernAppLayout><ReportOpsPayables /></ModernAppLayout></ProtectedRoute>} />
              ...
              <Route path="reports/email-monitoring" element={<ProtectedRoute requireAuth><ModernAppLayout><EmailMonitoringDashboard /></ModernAppLayout></ProtectedRoute>} />
              ...
              <Route path="finance/client-ledger" element={<ProtectedRoute requireAuth><ModernAppLayout><ClientLedger /></ModernAppLayout></ProtectedRoute>} />
              ...
              <Route path="portal-activity/suspicious" element={<ProtectedRoute requireAuth><ModernAppLayout><PortalSuspiciousLogins /></ModernAppLayout></ProtectedRoute>} />
              <Route path="portal-activity/user/:clientId" element={<ProtectedRoute requireAuth><ModernAppLayout><PortalActivityUser /></ModernAppLayout></ProtectedRoute>} />
