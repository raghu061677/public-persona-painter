...
const steps = [
  {
    ...
    description: "No credit card required for 14-day trial",
  },
  {
    icon: Upload,
    number: 2,
    title: "List or Browse",
    description: "Upload inventory or search 50K+ assets",
  },
  {
    icon: Rocket,
    number: 3,
    title: "Launch Campaigns",
    description: "AI-powered plans with real-time tracking",
  },
];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-base text-muted-foreground">
            From signup to your first campaign in under 15 minutes
          </p>
        </motion.div>
        ...
        <div className="flex flex-col sm:flex-row gap-3 justify-center mt-10">
          <Button 
            ...
            className="bg-gradient-to-r from-primary to-[#1D73E8] hover:opacity-90 rounded-full"
          >
