...
export const PremiumFooter = () => {
  ...
  return (
    <footer className="relative bg-gradient-to-b from-[#001226] to-[#000000] text-white overflow-hidden">
      {/* Cosmic Grid Overlay */}
      <div className="absolute inset-0 bg-[url('data:image/svg+xml;base64,')] opacity-20" />
