    ...
    const template = [
      {
        ...
        card_rate: 15000,
        base_rate: 5000,
        printing_rate_default: 2000,
        mounting_rate_default: 1000,
        status: "Available",
        is_public: true,
      }
    ];
      ...
      for (let i = 0; i < jsonData.length; i++) {
        ...
        try {
          ...
          const { error } = await supabase.from('media_assets').insert([{
            ...
            printing_rate_default: row.printing_rate_default || 0,
            mounting_rate_default: row.mounting_rate_default || 0,
