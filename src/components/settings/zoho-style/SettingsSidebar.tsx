...
const navigationGroups: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: "Email Providers", path: "/admin/company-settings/email-providers", icon: Server },
      { label: "Email Templates", path: "/admin/company-settings/email-template-manager", icon: FileText },
      { label: "Email Outbox", path: "/admin/company-settings/email-outbox", icon: Mail },
      { label: "Delivery Logs", path: "/admin/company-settings/email-delivery-logs", icon: Mail },
      { label: "Suppressions", path: "/admin/company-settings/email-suppressions", icon: Mail },
      { label: "Email Notifications", path: "/admin/company-settings/email-notifications", icon: Mail },
      { label: "SMTP Configuration", path: "/admin/company-settings/smtp-settings", icon: Server },
      { label: "Email Templates (Legacy)", path: "/admin/company-settings/email-templates", icon: FileText },
      { label: "Email Logs (Legacy)", path: "/admin/company-settings/email-logs", icon: Mail },
