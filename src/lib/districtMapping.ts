 ...
 * Comprehensive list of districts for each state/UT
 */
export const INDIAN_DISTRICTS: Record<string, string[]> = {
  ...
  'Punjab': [
    ...
    'Pathankot', 'Patiala', 'Rupnagar', 'Sangrur', 'Shahid Bhagat Singh Nagar', 'Tarn Taran'
  ],
  'Rajasthan': [
...
export function getDistrictsByState(stateName: string): string[] {
  return INDIAN_DISTRICTS[stateName] || [];
}

/**
 * Get all unique districts (sorted)
 */
