...
export const mediaAssetSchema = z.object({
  ...
  base_rate: z.number().min(0, "Base rate must be positive").max(99999999, "Base rate is too large").optional(),
  ...
  illumination_type: z.string().trim().max(50, "Illumination type must be less than 50 characters").optional().or(z.literal('')),
