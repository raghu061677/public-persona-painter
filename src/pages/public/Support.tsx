        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 lg:grid-cols-2 gap-12">
          <div>
            ...
            <div className="mt-8 space-y-3">
              ...
              <a href="https://api.whatsapp.com/send/?phone=919666444888&text=Hi%20Go-Ads%20support%20team&type=phone_number&app_absent=0" target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 p-4 rounded-xl border border-border hover:bg-muted/50 transition">
