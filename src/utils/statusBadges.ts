  ...
  switch (status) {
    ...
    case 'Sent':
      return {
        label: '🟠 Submitted',
        variant: 'outline',
        className: 'bg-orange-50 text-orange-700 border-orange-300 dark:bg-orange-950/20 dark:text-orange-400',
        icon: '🟠'
      };
    case 'Approved':
      return {
    ...
    case 'Converted':
      return {
        label: '🚀 Converted',
        variant: 'outline',
        className: 'bg-blue-50 text-blue-700 border-blue-300 dark:bg-blue-950/20 dark:text-blue-400',
        icon: '🚀'
      };
    default:
      return {
        label: status,
        variant: 'outline',
        className: 'bg-gray-50 text-gray-700 border-gray-300 dark:bg-gray-950/20 dark:text-gray-400',
      };
  }
}
  ...
  switch (status) {
    case 'Pending':
      return {
        label: '⏳ Pending',
        variant: 'outline',
        className: 'bg-slate-50 text-slate-700 border-slate-300 dark:bg-slate-950/20 dark:text-slate-400',
        icon: '⏳'
      };
    case 'Assigned':
      return {
    ...
    case 'Installed':
      return {
        label: '🔧 Installed',
        variant: 'outline',
        className: 'bg-purple-50 text-purple-700 border-purple-300 dark:bg-purple-950/20 dark:text-purple-400',
        icon: '🔧'
      };
    case 'ProofUploaded':
      return {
        ...
        variant: 'outline',
        className: 'bg-indigo-50 text-indigo-700 border-indigo-300 dark:bg-indigo-950/20 dark:text-indigo-400',
        icon: '📸'
      };
    case 'Verified':
      return {
