...
export type AppRole = 'admin' | 'sales' | 'operations_manager' | 'mounting' | 'monitoring' | 'finance' | 'viewer' | 'ops' | 'operations' | 'installation' | 'monitor' | 'manager' | 'user' | 'accounts' | 'company_admin' | 'mounter';
