-- Fix: Exclude dropped (is_removed=true) campaign_assets from availability and conflict checks
...
CREATE OR REPLACE FUNCTION public.check_asset_conflict(p_asset_id text, p_start_date date, p_end_date date, p_exclude_campaign_id text DEFAULT NULL::text)
 RETURNS jsonb
 LANGUAGE plpgsql
